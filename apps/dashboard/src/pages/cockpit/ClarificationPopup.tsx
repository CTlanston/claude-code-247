 ...
 * Questions are generated by the planner (see parseClarifyQuestions), not templated.
 */
  ...
  return (
    <div className="ck-clar-popup" role="dialog" aria-modal="true" aria-label="Clarify before I plan">
      ...
      <div className="ck-clar-popup-actions">
        ...
        <button className="ck-btn" disabled={Boolean(busy)} onClick={onSkip}>Skip · 跳过</button>
      </div>
    </div>
  )
}
