...
- [x] Daemon restart count >= target (not applicable to this stage)
...
## Notes
Stage M1 L1/L2 evidence reviewed from evidence/stage-M1/ and docs/reviews where applicable; no K/K2 soak prerequisite for this stage.
